...
MODEL_PATH = "/home/luck/yolov5_d435i_detection-main/blue1.2_blur.pt"
...
def draw_lock_rect(canvas: np.ndarray, x: int, y: int, shw: int, shh: int,
                   color: Tuple[int, int, int], p: float = 2.7, num_points: int = 100) -> None:
    """
...
class DetectionPipeline:
    ...
    def run(self, stop_event: threading.Event,
        ...
        fps_times: deque = deque(maxlen=60) # 存储近期时间戳，用于计算FPS
