...
EXPOSURE_VALUE = 350    # 手动曝光值（数值越小曝光越短）//基准500，调高亮，低暗

# ==================== 历史坐标超时清空 ====================
HISTORY_CLEAR_ENABLED = 1       # 0 = 禁用, 1 = 启用（无检测到时自动清空历史）
HISTORY_CLEAR_TIMEOUT = 5.0     # 超时时长（秒）

# ==================== YOLO 推理参数（按模式） ====================
# 2m                    1m
MODEL_2M_IMGSZ = 224;    MODEL_1M_IMGSZ = 640
MODEL_2M_CONF = 0.5;     MODEL_1M_CONF = 0.6
